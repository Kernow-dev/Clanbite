...
const STORE_NAMESPACE = 'clanspress-player-cover';
...
const { state, actions } = store( STORE_NAMESPACE, {
	...
	actions: {
		...
		showToast: createClanspressShowToast( getPlayerCoverState, {
			includeHeading: true,
		} ),

		hideToast: createClanspressHideToast( getPlayerCoverState ),
